...
function AuthModal({ isOpen, onClose, initialTab = 'login' }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Close modal after submission (you might want to modify this behavior)
    onClose();
  };
        ...
        {activeTab === 'login' ? (
          <>
            ...
            <div className="auth-footer">
              Don't have an account? <button className="text-link" onClick={() => setActiveTab('signup')}>Create Account</button>
            </div>
          </>
        ) : (
          <>
            ...
            <div className="auth-footer">
              Already have an account? <button className="text-link" onClick={() => setActiveTab('login')}>Log In</button>
            </div>
          </>
        )}
      </div>
